...
int main() {
    ...
    Test("seq"s, search_server, queries, execution::seq);
    Test("par"s, search_server, queries, execution::par);
    TestMatch("seq"s, search_server, query, execution::seq);
    TestMatch("par"s, search_server, query, execution::par);
}